...
import { POST_BY_ENTERTAINMENT_QUERY } from '@/sanity/lib/queries'
...
const page = async () => {
    ...
    const posts = await client.fetch(POST_BY_ENTERTAINMENT_QUERY)
        ...
        <div>
            ...
            <div className='flex items-center justify-center mb-10 bg-[#F4F0F8]'>
                <div className=' text-center my-10 p-10'>
                    ...
                    <h2 className='mt-5'>blog » Category » Entertainment</h2>
                </div>
            </div>
